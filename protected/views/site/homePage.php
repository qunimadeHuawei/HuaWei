...
<!--    footer starts here   -->
  ...
  <div id="function">
      <ul class="clearfix">
        <li><a data-ajax="false" href="<?php echo Yii::app()->createUrl('site/download'); ?>" class="x">下载<img src="<?php echo Yii::app()->baseUrl; ?>/Sites/images/function_icon1.png"></a></li>
        <li><a data-ajax="false" href="<?php echo Yii::app()->createUrl('site/copy'); ?>" class="y">复制<img src="<?php echo Yii::app()->baseUrl; ?>/Sites/images/function_icon2.png"></a></li>
        <li><a data-ajax="false" href="<?php echo Yii::app()->createUrl('site/move'); ?>" class="z">移动<img src="<?php echo Yii::app()->baseUrl; ?>/Sites/images/function_icon3.png"></a></li>
